...
describe XVocabularyDatastream do

  describe "a vocabulary model" do

    describe "instance populated in-memory" do

      subject { XVocabularyDatastream.new(stub('inner object', :pid=>'bbXXXXXX24', :new? => true), 'damsMetadata') }
    ...
    describe "an instance loaded from fixture xml" do
      ...
      subject do
        subject = XVocabularyDatastream.new(stub('inner object', :pid=>'bb15151515', :new? =>true), 'damsMetadata')
        subject.content = File.new('spec/fixtures/xVocabulary.rdf.xml').read
        subject
      end
