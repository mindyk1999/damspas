...
describe XVocabularyEntryDatastream do

  describe "a Vocabulary Entry model" do

    describe "instance populated in-memory" do

      subject { XVocabularyEntryDatastream.new(stub('inner object', :pid=>'bbXXXXXX24', :new? => true), 'damsMetadata') }
    ...
    describe "an instance loaded from fixture xml" do
      ...
      subject do
        subject = XVocabularyEntryDatastream.new(stub('inner object', :pid=>'bb47474747', :new? =>true), 'damsMetadata')
        subject.content = File.new('spec/fixtures/xVocabularyEntry.rdf.xml').read
        subject
      end
